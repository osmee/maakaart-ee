...
Stiil osm2pgsql -le eesti andmete impordiks. /var/lib/postgresql/estonia.style
...
node,way   name:et      text    linear # Eestikeelsed nimed
node,way   name:en      text    linear # Inglisekeelsed nimed, kui eestikeelset pole
