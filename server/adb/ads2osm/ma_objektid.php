...
$query = "select *,x(geom) as x,y(geom) as y from ma_objektid_geo where $mk geom && SetSRID('BOX3D($x1 $y1,$x2 $y2)'::box3d,3301)";
#$query = "select *,x(geom) as x,y(geom) as y from ma_objektid_geo where tase1_id='86'";
